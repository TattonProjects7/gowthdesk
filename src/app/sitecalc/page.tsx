...
import {
  Ruler, Box, BrickWall, Waves, Weight, ArrowLeftRight, ArrowRight, PencilRuler,
} from "lucide-react";
import { TOOLS, ACCENT } from "@/lib/sitecalc/tools";

const ICONS = { Ruler, Box, BrickWall, Waves, Weight, ArrowLeftRight, PencilRuler } as const;
